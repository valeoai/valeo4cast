...
Type_dict = {0: 'UNSET', 1: 'VEHICLE', 2: 'PEDESTRIAN', 3: 'CYCLIST', 4: 'OTHER'}
...
class MTRDecoder(nn.Module):
    ...
    def build_motion_query(self, d_model, use_place_holder=False):
        ...
        if use_place_holder:
            ...
            print("!!!!! WARNING: quick fix for accepting non-vehicle in intention_points_dict: !!!!!")
            for my_cls in ['PEDESTRIAN', 'CYCLIST', 'OTHER']:
                intention_points_dict[my_cls] = intention_points_dict['VEHICLE']
