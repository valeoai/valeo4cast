...
#        else:
    ...
    def get_agent_data(
        ...
        if "nei_weight_by_score" in self.config and self.config["nei_weight_by_score"]:
            ...
            object_onehot_mask[:, obj_types == 1, :, :][:,:,:,0] = object_scores[obj_types == 1][np.newaxis, :, :]
            object_onehot_mask[:, obj_types == 2, :, :][:,:,:,1] = object_scores[obj_types == 2][np.newaxis, :, :]
            object_onehot_mask[:, obj_types == 3, :, :][:,:,:,2] = object_scores[obj_types == 3][np.newaxis, :, :]
            object_onehot_mask[:, obj_types == 4, :, :][:,:,:,2] = object_scores[obj_types == 4][np.newaxis, :, :]
